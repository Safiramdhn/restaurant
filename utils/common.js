...
/**
 * A module to find the translation text by key and lang
 *
 * @exports translate
 * @param {object} object object value of lang and key
 * @returns {string} translation result
 */
exports.translate = function ({ lang = 'fr', key }) {
  // convert to upper case as en and fr.json files are named in upper case.
  key = key.toUpperCase();
  lang = lang.toUpperCase();

  // if key does not exist, return blank string.
  if (!key) {
    return '';
  }

  // get translated text;
  let translatedText = _.get(translations[lang], key, '');
